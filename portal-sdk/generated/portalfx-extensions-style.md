...
<a name="styling-style-custom-css-files"></a>
...
<a name="styling-style-style-sanitization"></a>
...
<a name="styling-style-themed-color-classes"></a>
...
<a name="styling-style-themed-color-classes-text-color-classes"></a>
### Text color classes
```css
...
<a name="styling-style-utility-classes-utility-classes"></a>
### Utility Classes
...
<a name="styling-style-utility-classes-deprecated-classes"></a>
### Deprecated Classes
...
<a name="styling-style-color-palette"></a>
## Style: Color Palette
...
<a name="styling-a-name-statuscolortext-a-coloring-to-convey-status"></a>
...
<a name="styling-a-name-bgcolortext-a-coloring-to-differentiate-data"></a>
...
<a name="styling-a-name-svgcolortext-a-coloring-svg"></a>
